...
<head>
  ...
  <title>Evening Classes Information</title>
  <!-- CSS reset -->
    ...
    <main>
      <section>
        ...
        <div class="col_flex_box">
          ...
          <div class="column">
            <p>First time students: Please arrive 5+ minutes before the start of class to complete student registration. All props needed for classes will be provided for you. Just bring a towel and some water as needed.</p>
            <p>Please read our Cancellation and Refunds Policy below carefully before booking your place on a class, course or Workshop.</p>
          </div>
          <!-- column class styles the width of the respectitive child element -->
          <div class="column">
            <h4>Pricelist</h4>
        ...
        <div class="col_flex_box">
          ...
          <div class="column">
            <figure class="img_align">
              <img src="images/classes/yoga_stretch.png" alt="#" class="img_size">
            </figure>
          </div>
        </div>
      </section>
      <section>
        <h3>CANCELLATION & REFUNDS POLICY</h3>
        <p>All class fees are non-refundable & all class packages are non-refundable & non-transferable & must be used within the specified time.</p>
        <p>Refunds: For a refund on pre-booked 'courses', 'classes' or 'workshops', the class would need to be cancelled more than 24 hours prior to the commencement date of the course or class.</p>
        <p>A minimum of 24 hours notice is required for cancellations.  If cancellation is made less than 24 hours before a 'class', 'course' or 'workshop' commences, the cost of one drop-in class or workshop cost will be retained.</p>
        <p>Refunds will not be made once 'course' commences.  It is not possible to carry forward missed classes from a pre-booked 'course' into the next session/course.</p>
      </section>
      <section>
      ...
      <section><!-- testimonials area -->
        <h3 id="evening_head">Testimonials</h3>
        <div class="col_flex_box">
          <div class="column">
            <!-- start of php  -->
            <?php
            ...
            if ($result = $con->query("SELECT * FROM users WHERE catagorey = 'Evening Class' ORDER BY id DESC"))
            {
